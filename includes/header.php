        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/app/views/pacientes/lista.php">
                            <i class="bi bi-people-fill"></i> Pacientes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/app/views/visitas/lista.php">
                            <i class="bi bi-calendar-check"></i> Visitas
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-clipboard2-pulse"></i> Análisis
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/app/views/analisis/glucosa.php">Glucosa</a></li>
                            <li><a class="dropdown-item" href="/app/views/analisis/perfil_renal.php">Perfil Renal</a>
                            </li>
                            <li><a class="dropdown-item" href="/app/views/analisis/perfil_lipidico.php">Perfil
                                    Lipídico</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/app/views/reportes/index.php">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="/app/logout.php">
