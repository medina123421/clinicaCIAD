<?php
/**
 * AJAX: Buscar Pacientes para Medicina Interna
    ...
    if (count($pacientes) > 0) {
        foreach ($pacientes as $p) {
            ...
            if ($p['ultima_visita_id']) {
                $html .= '    <a href="medicina_interna.php?id_visita=' . $p['ultima_visita_id'] . '" class="btn btn-sm btn-outline-primary rounded-pill">';
