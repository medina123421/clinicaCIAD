<?php
/**
 * AJAX: Buscar Pacientes para Actividad Física
 * Retorna lista de pacientes con enlaces a sus visitas (especialidad Actividad Física)
 */
    ...
    if (count($pacientes) > 0) {
        foreach ($pacientes as $p) {
            ...
            if ($p['ultima_visita_id']) {
                $html .= '    <a href="actividad_fisica.php?id_visita=' . (int)$p['ultima_visita_id'] . '" class="btn btn-sm btn-outline-primary rounded-pill">';
