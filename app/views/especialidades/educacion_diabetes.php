...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0"><i class="bi bi-mortarboard-fill text-warning me-2"></i>Educación en Diabetes</h2>
            <?php if ($paciente && $visita): ?>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Educación en Diabetes</li>
                    </ol>
                </nav>
            <?php else: ?>
                <nav aria-label="breadcrumb">
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-warning text-white d-flex align-items-center">
                        ...
                        <span>Seleccionar Paciente &mdash; Educaci&oacute;n en Diabetes</span>
                    </div>
                    <div class="card-body p-4">
                        <p class="text-muted mb-4">Busque y seleccione al paciente para realizar su evaluaci&oacute;n de Educaci&oacute;n en Diabetes.</p>
                        <div class="input-group mb-4">
                            <span class="input-group-text bg-white border-end-0"><i class="bi bi-search text-muted"></i></span>
                            <input type="text" class="form-control border-start-0 border-warning border-opacity-25"
                            ...
                            <div class="list-group-item list-group-item-action p-3 border-bottom patient-item"
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <?php if ($p['ultima_visita_id']): ?>
                                        <a href="educacion_diabetes.php?id_visita=<?= $p['ultima_visita_id'] ?>"
                                            class="btn btn-sm btn-outline-warning rounded-pill">
                                            <i class="bi bi-mortarboard-fill align-middle fs-6"></i> Evaluar
                        ...
                        <div class="mt-3 text-center">
                            <small class="text-muted">&iquest;Paciente sin visita? <a href="<?= PROJECT_PATH ?>/app/views/visitas/nueva.php" class="text-warning">Registrar nueva visita</a></small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php else: ?>
        ...
        <?php if (!empty($datos) && isset($datos['semaforo_educativo'])): ?>
            <div class="row mb-4">
                <div class="col-12">
                    <div
                        class="alert alert-<?= $datos['semaforo_educativo'] == 'Verde' ? 'success' : ($datos['semaforo_educativo'] == 'Amarillo' ? 'warning' : 'danger') ?> d-flex align-items-center">
                        <i class="bi bi-traffic-light fs-3 me-3"></i>
                        <div>
                            <h5 class="mb-1">Semáforo Educativo: <?= $datos['semaforo_educativo'] ?></h5>
                            <p class="mb-0">Nivel de Autonomía:
                                <strong><?= $datos['nivel_autonomia'] ?? 'No definido' ?></strong></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form method="POST" id="form_educacion_diabetes">
            ...
            <ul class="nav nav-tabs mb-4" id="educacionTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="diagnostico-tab" data-bs-toggle="tab" data-bs-target="#diagnostico"
                        type="button">
                        <i class="bi bi-clipboard-check me-1"></i>Diagnóstico Educativo
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="habilidades-tab" data-bs-toggle="tab" data-bs-target="#habilidades"
                        type="button">
                        <i class="bi bi-syringe me-1"></i>Habilidades Técnicas
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="problemas-tab" data-bs-toggle="tab" data-bs-target="#problemas"
                        type="button">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="nutricion-tab" data-bs-toggle="tab" data-bs-target="#nutricion"
                        type="button">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                <div class="card-header bg-warning text-white">
                                    <h6 class="mb-0"><i class="fas fa-exclamation-circle me-2"></i>Diagnósticos Educativos
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="conocimientos_deficientes_nutricion"
                                            id="conocimientos_deficientes_nutricion"
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="no_cumple_recomendaciones"
                                            id="no_cumple_recomendaciones" <?= (!empty($datos['no_cumple_recomendaciones'])) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="ingesta_excesiva_carbohidratos" id="ingesta_excesiva_carbohidratos"
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="manejo_inadecuado_hipoglucemia" id="manejo_inadecuado_hipoglucemia"
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="barrera_nivel_educativo"
                                            id="barrera_nivel_educativo" <?= (!empty($datos['barrera_nivel_educativo'])) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="barrera_nivel_educativo">
                                            Nivel educativo limitado
                                        </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="barrera_economica"
                                            id="barrera_economica" <?= (!empty($datos['barrera_economica'])) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="barrera_economica">
                                            Limitaciones económicas
                                        </label>
                                    </div>
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="barrera_apoyo_familiar"
                                            id="barrera_apoyo_familiar" <?= (!empty($datos['barrera_apoyo_familiar'])) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="barrera_apoyo_familiar">
                                            Falta de apoyo familiar
                                        </label>
                                    </div>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="barrera_psicologica"
                                            id="barrera_psicologica" <?= (!empty($datos['barrera_psicologica'])) ? 'checked' : '' ?>>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea class="form-control" name="otras_barreras" id="otras_barreras"
                                            rows="2"><?= $datos['otras_barreras'] ?? '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-sm mb-4">
                                <div class="card-header bg-warning text-white">
                                    <h6 class="mb-0"><i class="fas fa-syringe me-2"></i>Técnica de Inyección de Insulina
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="tecnica_seleccion_jeringa" class="form-label">Selección de
                                                jeringa/aguja:</label>
                                            <select class="form-select" name="tecnica_seleccion_jeringa"
                                                id="tecnica_seleccion_jeringa">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="tecnica_angulacion_pliegue" class="form-label">Angulación y
                                                pliegue:</label>
                                            <select class="form-select" name="tecnica_angulacion_pliegue"
                                                id="tecnica_angulacion_pliegue">
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="interpretacion_resultados" class="form-label">Interpretación de
                                                resultados:</label>
                                            <select class="form-select" name="interpretacion_resultados"
                                                id="interpretacion_resultados">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="identificacion_sintomas_hipo" class="form-label">Identificación de
                                            síntomas:</label>
                                        <select class="form-select" name="identificacion_sintomas_hipo"
                                            id="identificacion_sintomas_hipo">
                                    ...
                                    <div class="mb-3">
                                        <label for="aplicacion_regla_15" class="form-label">Aplicación "Regla de los
                                            15":</label>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="identificacion_sintomas_hiper" class="form-label">Identificación de
                                            síntomas:</label>
                                        <select class="form-select" name="identificacion_sintomas_hiper"
                                            id="identificacion_sintomas_hiper">
                        ...
                        <div class="col-md-8">
                            <div class="card shadow-sm mb-4">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0"><i class="bi bi-clipboard-heart me-2"></i>Inventario de Depresión de
                                        Beck II (BDI-2)</h6>
                                </div>
                                <div class="card-body">
                                    <p class="small text-muted">
                                        Cada ítem se califica de 0 a 3. La suma total se calcula en el servidor y se
                                        clasifica como:
                                ...
                                <div class="card-body">
                                    ...
                                    <select name="estado_cambio" id="estado_cambio" class="form-select">
                                        ...
                                        foreach ($estados as $e):
                                            ?>
                                            <option value="<?= $e ?>" <?= $estadoActual === $e ? 'selected' : '' ?>><?= $e ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="conteo_carbohidratos_nivel" class="form-label">Nivel de
                                            comprensión:</label>
                                        <select class="form-select" name="conteo_carbohidratos_nivel"
                                            id="conteo_carbohidratos_nivel">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="evita_refrescos"
                                            id="evita_refrescos" <?= (!empty($datos['evita_refrescos'])) ? 'checked' : '' ?>>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="meta_hba1c_objetivo"
                                                id="meta_hba1c_objetivo" step="0.1" min="6" max="10"
                                                value="<?= $datos['meta_hba1c_objetivo'] ?? '7.0' ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="nuevas_metas_establecidas" class="form-label">Nuevas metas
                                            establecidas:</label>
                                        <textarea class="form-control" name="nuevas_metas_establecidas"
                                            id="nuevas_metas_establecidas"
                                            rows="3"><?= $datos['nuevas_metas_establecidas'] ?? '' ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control" name="observaciones_educador" id="observaciones_educador"
                                        rows="8"
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control" name="material_educativo_entregado"
                                        id="material_educativo_entregado" rows="8"
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (buscarInput && resultados) {
            ...
            buscarInput.addEventListener('input', debounce(function () {
                ...
                xhr.open('GET', '<?= PROJECT_PATH ?>/app/ajax/buscar_pacientes_diabetes.php?search=' + encodeURIComponent(termino));
                xhr.onload = function () {
                    try {
